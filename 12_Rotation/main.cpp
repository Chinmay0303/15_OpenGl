...
void CreateVertexBuffer(){
    ...
    Vector3f p0 = Vector3f(-0.5f,-0.5f,0.0f); //left
    Vector3f p1 = Vector3f(0.0f,0.0f,0.0f); //top
    Vector3f p2 = Vector3f(0.5f,-0.5f,0.0f); //right
...
static void CompileShaders()
{
    ...
    if (gRotateLocation == -1) {
        ...
        std::cout << "gRotateLocation: " << gRotateLocation << "\n";
    }
