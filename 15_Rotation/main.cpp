...
void CreateVertexBuffer(){
    ...
    float Delta = 360.0f / Triangles;

    std::cout << "Delta: " << Delta << "\n";
    
    float DeltaInRadians = 2.0f * M_PI * Delta/360.0f;
    ...
    while(i < N){
        ...
        p2 = Vertices[i-1];
        Vertices[i+1] = p2; //second vertex: last vertex
        Vector3f p3 = RotateDot * p2;
        Vertices[i+2] = p3; // third vertex: rotated vertex

        // std::cout << "Angle: " << AngleInDegrees << "\n"
        // << "p0: "<< p0.x << ","<< p0.y << ","<< p0.z << "\n"
        // << "p2: "<< p2.x << ","<< p2.y << ","<< p2.z << "\n"
        // << "p3: "<< p3.x << ","<< p3.y << ","<< p3.z << "\n";
